...
/**
 * Cette classe d�finit un formulaire de base pour les contacts. 
 * 
...
public abstract class BaseFicheContact extends PanelConstructDefaut implements Serializ
{
	 ...
	 * @param contenuPrenom, le pr�nom du contact 
	 * @param contenuNom, la longueur du num�ro de t�l�phone du contact 
